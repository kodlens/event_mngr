                ...
                <div class="column is-11-desktop is-10-widescreen">
                    <div class="box">
                        ...
                        <div class="is-flex is-justify-content-center mb-2"
                            style="font-size: 20px; font-weight: bold;">EVENT EVALUATIONS</div>
                        <hr>
                        <div class="level">
                        ...
                        <b-table
                            ...
                            <b-table-column field="evaluation_id" label="ID" v-slot="props">
                                {{ props.row.evaluation_id }}
                            </b-table-column>
