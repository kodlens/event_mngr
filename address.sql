...
/*Table structure for table `custom_recipients` */

DROP TABLE IF EXISTS `custom_recipients`;

CREATE TABLE `custom_recipients` (
  `custom_recipient_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `event_id` bigint(20) unsigned NOT NULL,
  `email` varchar(50) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`custom_recipient_id`),
  KEY `custom_recipients_event_id_foreign` (`event_id`),
  CONSTRAINT `custom_recipients_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`event_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `custom_recipients` */
...
CREATE TABLE `event_files` (
  `event_file_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `event_id` bigint(20) unsigned NOT NULL,
  `event_filename` varchar(100) DEFAULT NULL,
  `event_file_path` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`event_file_id`),
  KEY `event_files_event_id_foreign` (`event_id`),
  CONSTRAINT `event_files_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`event_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `event_files` */
...
(9,'CONVENTION HALL/BALLROOM',1,NULL,NULL);
...
CREATE TABLE `events` (
  ...
  `event_venue_id` bigint(20) unsigned NOT NULL DEFAULT 0,
  ...
  `approve_by_id` bigint(20) unsigned DEFAULT 0,
  `is_archive` tinyint(4) NOT NULL DEFAULT 0,
  `archive_date` date DEFAULT NULL,
  `ao_user_id` bigint(20) unsigned DEFAULT 0,
  `remarks_decline` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
insert  into `events`(`event_id`,`academic_year_id`,`user_id`,`event_venue_id`,`event_type_id`,`if_others`,`event`,`event_description`,`event_content`,`event_date_from`,`event_date_to`,`event_time_from`,`event_time_to`,`img_path`,`file_path`,`approval_status`,`is_open`,`is_need_approval`,`approve_by`,`approve_by_id`,`is_archive`,`archive_date`,`ao_user_id`,`remarks_decline`,`created_at`,`updated_at`,`department_id`) values 
(1,1,2,0,1,NULL,'TES & TDP RELEASE','','ATTENTION FOR ALL TES AND TDP GRANTEES! THERE WILL BE AN UPCOPING RELEASE FOR YOUR GRANTS THIS COMING FRIDAY NOVEMBER 17,2023 IN THE ADMINSTRATION BULDING, RELEASE WILL START AT EXACTLY 8:00AM IN THE MORNING. THANK YOU!','2023-09-22','2023-09-22','13:00:00','17:00:00','gbeDdXVEl7nljb93hFvE4vVc2pA8jhzqH9ChDqHe.jpg','',1,0,0,NULL,0,0,NULL,8,NULL,NULL,NULL,5),
(2,1,2,0,1,NULL,'Monthly Mass','','<p><strong>Announcement Blue Generals.</strong></p><p><br></p><p><br></p><p>We will have a monthly mass this afternoon. All students are required to attend.</p>','2023-09-22','2023-09-22','13:00:00','17:00:00','T6qZYwDpIdOmhDkLvkFUTPV306j7DsoL18ieCxTG.jpg','',1,1,0,NULL,0,0,NULL,8,NULL,NULL,NULL,5);
...
(5,'2023_09_05_222004_create_academic_years_table',1),
(6,'2023_09_05_222005_create_events_table',1),
(7,'2023_09_05_222111_create_event_attendances_table',1),
(8,'2023_09_17_065432_create_questions_table',1),
(9,'2023_10_28_215830_create_event_types_table',1),
(10,'2023_11_20_142857_create_evaluations_table',1),
(11,'2023_11_20_143028_create_legends_table',1),
(12,'2023_11_20_144020_create_departments_table',1),
(13,'2023_11_25_035701_create_evaluation_answers',1),
(14,'2023_11_28_225547_create_event_venues_table',1),
(15,'2023_12_01_163020_create_event_attendees_table',1),
(16,'2023_12_22_093253_create_event_files_table',1),
(17,'2023_12_28_115452_create_jobs_table',1),
(18,'2023_12_29_040722_add_column_to_events_table',1),
(19,'2024_01_05_084708_create_custom_recipients_table',1);
...
(1,'ABC123','admin','SARSABA','ELNIE CHAN','','','elniechan.sarsaba@nmsc.edu.ph',NULL,'MALE','ADMINISTRATOR','2023-11-20 14:49:07','$2y$10$U.hz0BzH7EwZ1NMuKqicyOTscUoMXmh58pAi4BMrBkbccuwj4n0UC',1,0,NULL,NULL,NULL),
(2,'AAA222','mark','PRIETO','MARK ANTHONY','','','markanthony.prieto@nmsc.edu.ph',NULL,'MALE','REQUESTING PARTY','2023-11-20 14:49:07','$2y$10$cIF8jXXIMerht0oEElYDU.hcJi7g6HUEgLJEDOoWlZDqxOlSb1kiy',1,0,NULL,NULL,NULL),
(3,'847F4671','sheen','DELOSA','SHEEN','','','sheen.delosa@nmsc.edu.ph',NULL,'FEMALE','ATTENDEE','2023-11-20 14:49:07','$2y$10$fjzixuNPNL8zsbXcD6DbTu3Am0Fvs8e4mgkzyfvcUg3f1yZlhSAfK',1,0,NULL,NULL,NULL),
(4,'D2823EDF','Cherryl','GALLEGO','CHERRYL','LANSAM','','cherryl.gallego@nmsc.edu.ph',NULL,'FEMALE','ATTENDEE','2023-11-20 14:49:07','$2y$10$aDLuGdPA2HyjCa12ZBNMVu3VNc6pKcetgISzpUqX7IYaexcs82xf.',1,0,NULL,NULL,NULL),
(5,'D2823E111','juan','DELA CRUZ','JUAN','','','juan@nmsc.edu.ph',NULL,'MALE','ATTENDEE','2023-11-20 14:49:07','$2y$10$SDlYpwfrlKRAFPE8bCskcOlHbRWwz9TguTIlBrNs2XQdbW5CcK20W',1,0,NULL,NULL,NULL),
(6,'D2823222','jane','GOMEZ','JANE','','','jane@nmsc.edu.ph',NULL,'FEMALE','ATTENDEE','2023-11-20 14:49:07','$2y$10$WLS51F/wA.oDWZRcSZ1uKO0gcZahnWKuwFWEzr37GG/pLg5iYrCXa',1,0,NULL,NULL,NULL),
(7,'D2823333','jenny','GALEZ','JENNY','','','jenny@nmsc.edu.ph',NULL,'FEMALE','APPROVING OFFICER','2023-11-20 14:49:07','$2y$10$7NG1TN5D6VsrSPJX2dOyJOOL2lXrjqNmuoQO9uThl7x9PsnQjGK0G',1,0,NULL,NULL,NULL),
(8,'D2824444','rhea','MENDEZ','RHEA','','','rhea@nmsc.edu.ph',NULL,'FEMALE','APPROVING OFFICER','2023-11-20 14:49:07','$2y$10$BgWHW.7sygmSy3MNQsMFfO/dYYRvGk7FDE1AsxxllhZjpxWUTuDsy',1,0,NULL,NULL,NULL);
