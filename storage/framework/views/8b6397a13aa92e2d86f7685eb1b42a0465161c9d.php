<?php $__env->startSection('content'); ?>
    ...
    <?php if($id > 0): ?>
        <event-page-create-edit :prop-id="<?php echo e($id); ?>" :prop-data='<?php echo json_encode($data, 15, 512) ?>'></event-page-create-edit>

    <?php else: ?>
        <event-page-create-edit :prop-id="0" :prop-data='<?php echo json_encode($data, 15, 512) ?>'></event-page-create-edit>
